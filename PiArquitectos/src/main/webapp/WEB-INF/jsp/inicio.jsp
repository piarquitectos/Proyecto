...
<body id="page-top">
  ...
  <section class="portfolio" id="portfolio">
    <div class="container">
      ...
      <form action="${pageContext.request.contextPath}/guardarHerramienta" method="POST">
        ...
        <thead>
          ...
          <tbody>
            <tr>
              ...
              <td><input type="number" class="form-control" name="no_serie" id="no_serie"/></td>
              ...
              <td><input type="date" class="form-control" name="fecha_alta" id="fecha_alta" /></td>
              <td><input type="date" class="form-control" name="fecha_baja" id="fecha_baja"/></td>
            ...
            <td><input type="text" class="form-control" name="subtipo" id="subtipo" /></td>
            <td><input type="number" class="form-control" name="codigo" id="codigo" /></td>
          </tr>
        </tbody>
      </table>
